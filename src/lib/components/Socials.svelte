<script lang="ts">
	...
	const socials: Social[] = [
		{
			name: 'GitHub',
			url: 'https://github.com/jdboachie',
		...
		{
			name: 'Email',
			url: 'mailto:jdboachie@gmail.com',
...
<div class="mb-12 flex items-center justify-center gap-6">
	{#each socials as social}
		<a
			...
			class="hover:text-foreground text-muted transition-colors duration-300 ease-out"

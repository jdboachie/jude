...
<Image
  ...
  width={5000}
  height={5000}
  className='mt-6 sm:col-span-3 max-lg:w-full max-w-[960px] mx-auto border border-neutral-300 dark:border-neutral-600 bg-neutral-100 dark:bg-neutral-800 rounded-xl z-10'
/>

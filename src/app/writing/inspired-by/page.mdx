...
<BlockQuote>gotta turn this into a carousel component</BlockQuote>
...
Interesting to note that Rauno Frieberg uses the same orange dot <span className="mx-1 inline-flex size-4 bg-orange-500 rounded-full" /> as Rasmus Andersson.
...
On the other hand, there are those that advocate being _"original"_.
...
My personal site is heavily inspired by [paco.me](https://paco.me) and [rauno.me](https://rauno.me). I'm happy with what I've built for now. I'll redesign when I find new inspiration. Keep learning.

PS: I have felt very indecisive releasing this post. It constantly felt unfinished and unpolished. But I need to move on to other things. Hope you enjoyed it!
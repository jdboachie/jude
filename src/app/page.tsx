...
function TwitterIcon() {
  return (
    <svg className={iconStyles} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill='#000000' viewBox="0 0 256 256"><path d="M208,216H160L48,40H96Z" opacity="0.2"></path><path d="M214.75,211.71l-62.6-98.38,61.77-67.95a8,8,0,0,0-11.84-10.76L143.24,99.34,102.75,35.71A8,8,0,0,0,96,32H48a8,8,0,0,0-6.75,12.3l62.6,98.37-61.77,68a8,8,0,1,0,11.84,10.76l58.84-64.72,40.49,63.63A8,8,0,0,0,160,224h48a8,8,0,0,0,6.75-12.29ZM164.39,208,62.57,48h29L193.43,208Z"></path></svg>
  )
}
    ...
    <LazyMotion features={domAnimation} strict>
      ...
      >
        ...
        variants={staggerChildrenVariants}
          className={"mb-8 text-9xl max-md:text-7xl mx-8 font- italic tracking-tighter"}
        >
          Jude Boachie
        </m.h1>
        ...
        <m.div variants={staggerChildrenVariants}>
          <span className={'text-lg font-medium'}>Light of the world.</span>{' '}
          ...
          Mastering all manner of craft. Computer Engineering @KNUST.{' '}<span className='inline-flex'>Total Success</span>
        </m.div>
        <m.div variants={staggerChildrenVariants}>
          <p className={'text-xs leading-loose pt-2 font-medium'}>Past</p>
        ...
        <m.div variants={staggerChildrenVariants}>
          <p className={'text-xs leading-loose pt-2 font-medium'}>Now</p>
        ...
        <m.div variants={staggerChildrenVariants} className="flex flex-col">
          <p className={'leading-loose pt-2 text-xs font-medium'}>Connect</p>

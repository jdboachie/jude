    ...
    <LazyMotion features={domAnimation} strict>
      ...
      >
        ...
        variants={staggerChildrenVariants}
          className={cx("mb-8 text-6xl font-medium tracking-tigter", display.className)}
        >
          Jude Boachie
        </m.h1>

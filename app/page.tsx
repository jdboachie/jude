    ...
    <LazyMotion features={domAnimation} strict>
      ...
      >
        ...
        variants={staggerChildrenVariants}
          className={cx("mb-8 text-9xl max-md:text-7xl max-md:px-4 font-medium tracking-tigter", display.className)}
        >
          Jude Boachie
        </m.h1>
